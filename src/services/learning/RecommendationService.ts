...
import type { RecommendationLog, SmartRecommendation } from "@/types/learning";
...
export class RecommendationService {
	...
	static async generateRecommendations(
		...
		await RecommendationService.logRecommendation({
			userId,
			dogId,
	...
	static async logRecommendation(
		log: Omit<RecommendationLog, "id" | "createdAt">,
	): Promise<void> {
		try {
