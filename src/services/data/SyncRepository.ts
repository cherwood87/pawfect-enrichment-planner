...
export class SyncRepository {
  static async fullSync(
    ...
    try {
      ...
      return await ActivitySyncService.fullSync(discoveredActivities, userActivities, dogId);
    } catch (error) {
  ...
  static async syncDiscoveredActivities(
    ...
    return await SupabaseAdapter.syncActivitiesToSupabase(activities, 'discovered', dogId);
  }
  ...
  static async syncUserActivities(
    ...
    return await SupabaseAdapter.syncActivitiesToSupabase(activities, 'user', dogId);
  }
