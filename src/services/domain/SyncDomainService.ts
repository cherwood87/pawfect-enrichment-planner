...
export class SyncDomainService {
  static async performFullSync(
    ...
    return await SyncRepository.fullSync(discoveredActivities, userActivities, dogId);
  }
  ...
  static async syncDiscoveredActivities(
    ...
    console.log(`Domain service syncing ${activities.length} discovered activities for dog ${dogId}...`);
  ...
  static async syncUserActivities(
    ...
    console.log(`Domain service syncing ${activities.length} user activities for dog ${dogId}...`);
