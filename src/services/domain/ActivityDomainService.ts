...
export class ActivityDomainService {
  ...
  static async toggleActivityCompletion(
    ...
    return ActivityBusinessLogicService.toggleActivityCompletion(activityId, dogId, completionNotes);
  }
  ...
  static async updateScheduledActivity(
    ...
    return ActivityBusinessLogicService.updateScheduledActivity(activityId, dogId, updates);
  }
  ...
  static getTodaysActivities(
    ...
    return ActivityAnalyticsService.getTodaysActivities(scheduledActivities, currentDog);
  }
  ...
  static getActivityDetails(
    ...
    return ActivityAnalyticsService.getActivityDetails(activityId, userActivities, discoveredActivities, currentDog);
  }
  ...
  static calculateStreakData(
    ...
    return ActivityAnalyticsService.calculateStreakData(scheduledActivities, currentDog);
  }
  ...
  static calculateWeeklyProgress(
    ...
    return ActivityAnalyticsService.calculateWeeklyProgress(scheduledActivities, currentDog);
  }
  ...
  static calculatePillarBalance(
    ...
    return ActivityAnalyticsService.calculatePillarBalance(scheduledActivities, userActivities, discoveredActivities, currentDog);
  }
