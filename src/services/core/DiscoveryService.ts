...
export class DiscoveryService {
	...
	static async discoverNewActivities(
		...
		return DiscoveryDomainService.discoverNewActivities(
			discoveredActivities,
			discoveryConfig,
			currentDog,
		);
	...
	static async approveActivity(
		...
		return DiscoveryDomainService.approveDiscoveredActivity(
			activityId,
			discoveredActivities,
			dogId,
		);
	...
	static async rejectActivity(
		...
		return DiscoveryDomainService.rejectDiscoveredActivity(
			activityId,
			discoveredActivities,
			dogId,
		);
	...
	static async updateDiscoveryConfig(
		...
		return DiscoveryDomainService.updateDiscoveryConfig(
			dogId,
			currentConfig,
			updates,
		);
