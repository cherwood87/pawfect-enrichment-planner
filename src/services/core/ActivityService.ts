...
export class ActivityService {
  ...
  static async updateScheduledActivity(
    ...
    return ActivityDomainService.updateScheduledActivity(activityId, dogId, updates);
  }
  ...
  static async toggleActivityCompletion(
    ...
    return ActivityDomainService.toggleActivityCompletion(activityId, dogId, completionNotes);
  }
