...
export const validateImportPath = (path: string): boolean => {
  const allPaths = [
    ...Object.values(COMPONENT_PATHS).flatMap(section => Object.values(section)),
    ...Object.values(HOOK_PATHS),
    ...Object.values(CONTEXT_PATHS),
    ...Object.values(TYPE_PATHS),
    ...Object.values(SERVICE_PATHS).flatMap(section => Object.values(section)),
