...
export class SchedulingValidator {
	...
	static validateScheduledActivity(
		...
		const dogValidation = SchedulingValidator.validateDogContext(dog);
		...
		if (!activity.scheduledDate) {
			...
			// Validate date
			const dateValidation = SchedulingValidator.validateScheduledDate(
		...
		const weekDayValidation = SchedulingValidator.validateWeekAndDay(
			activity.weekNumber,
			activity.dayOfWeek,
		);
