...
export const useInteractionTracking = () => {
  ...
  const trackActivityView = useCallback((activityId: string, activityType: 'library' | 'user' | 'discovered', pillar?: string) => {
  ...
  const trackActivitySchedule = useCallback((activityId: string, activityType: 'library' | 'user' | 'discovered', scheduledDate: string) => {
  ...
  const trackActivityComplete = useCallback((activityId: string, activityType: 'library' | 'user' | 'discovered', duration?: number) => {
  ...
  const trackActivitySkip = useCallback((activityId: string, reason?: string) => {
  ...
  const trackSearch = useCallback((query: string, pillar?: string, results?: number) => {
