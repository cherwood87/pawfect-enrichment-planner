...
const DashboardContent: React.FC<DashboardContentProps> = ({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-cyan-50 to-amber-50">
      <div className="container-primary spacing-section">
        ...
        <div className="mb-8">
          <div className="card-elevated padding-section animate-fade-in-up">
            ...
            {favouritesLoading ? (
              <div className="text-purple-600 text-center py-8 card-surface rounded-2xl border-2 border-purple-200">
                <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-purple-500 mx-auto mb-3"></div>
                Loading favourites...
              </div>
            ) : favourites.length === 0 ? (
              <div className="text-purple-600 text-center py-8 card-secondary rounded-2xl border-2 border-purple-200">
              ...
              <div className="spacing-content">
                {favourites.map(favourite => (
                  <div key={favourite.id} className="card-primary padding-content flex flex-col md:flex-row md:items-center md:justify-between interactive-hover transition-all duration-300">
                    <div className="flex-1">
                      <div className="font-semibold text-purple-800 mb-2">{favourite.title}</div>
