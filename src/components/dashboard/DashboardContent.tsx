      ...
      <div className="container mx-auto mobile-container mobile-space-y">
        ...
        <div className="mb-8">
          <div className="modern-card p-6 rounded-sm bg-slate-50">
            ...
            {favouritesLoading ? <div className="text-purple-600 text-center py-8 bg-purple-50 rounded-2xl border border-purple-200">
                <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-purple-500 mx-auto mb-3"></div>
                Loading favourites...
              </div> : favourites.length === 0 ? <div className="text-purple-600 text-center py-8 bg-gradient-to-br from-purple-50 to-cyan-50 rounded-2xl border-2 border-purple-200">
                ...
                {favourites.map(favourite => <div key={favourite.id} className="modern-card p-4 flex flex-col md:flex-row md:items-center md:justify-between hover:shadow-xl transition-all duration-300">
                    ...
                    <div className="flex mt-3 md:mt-0 md:ml-4 space-x-3 items-center">
                      ...
                      {showDayPickerFor === favourite.id && <div className="flex items-center space-x-2 ml-2">
