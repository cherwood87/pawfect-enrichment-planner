  ...
  return <div className="min-h-screen bg-gradient-to-br from-purple-50 via-cyan-50 to-amber-50">
      <div className="container mx-auto mobile-container mobile-space-y">
        ...
        <div className="text-center">
          <Button onClick={handleGetTodaysActivities} className="w-full bg-gradient-to-r from-purple-500 via-cyan-500 to-amber-500 hover:from-purple-600 hover:via-cyan-600 hover:to-amber-600 text-white font-semibold py-4 text-lg rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02] touch-target mx-0 px-[25px]">
            Get Today's Activities for {currentDog.name}
          </Button>
        </div>

        {/* Weekly Progress Summary */}
        <WeeklyProgressSummary completedActivities={completedThisWeek} totalPlannedActivities={totalPlannedThisWeek} />
