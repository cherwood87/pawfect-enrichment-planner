...
const VerticalDayCard = memo<VerticalDayCardProps>(({
  ...
  return (
    <div className={`rounded-3xl ${backgroundClass} shadow-md border border-purple-100 p-5 flex flex-col gap-2 ${hasLoadingActivities || isRetrying ? 'opacity-75' : ''} transition-opacity`}>
