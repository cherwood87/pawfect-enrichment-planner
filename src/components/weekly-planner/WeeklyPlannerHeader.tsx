import { Calendar, CalendarDays, Grid3x3, Plus, Trophy } from "lucide-react";
          ...
          `}
					...
					<div>
						<CardTitle className="text-2xl font-bold text-purple-800 flex items-center space-x-3">
							<span>
								{viewMode === "week" ? "Weekly Planner" : "Daily Focus"}
							</span>
							{isComplete && (
				...
				<div className="flex items-center space-x-4">
					...
					{totalActivities > 0 && (
						<Badge
							className={`font-bold px-4 py-2 rounded-xl text-base ${
								isComplete
