...
const VerticalDayCard: React.FC<VerticalDayCardProps> = ({
  ...
  const getCompletionStatus = () => {
    ...
    if (completedCount === totalCount) return { color: 'bg-emerald-100', text: 'text-emerald-700', label: 'Complete!' };
    if (completedCount > 0) return { color: 'bg-blue-100', text: 'text-blue-700', label: `${completedCount} done` };
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between text-xs">
                      <Badge 
                        className={`bg-gradient-to-r ${pillarGradient} text-white border-0 text-xs px-2 py-1`}
                      >
                    ...
                    {activity.completed && activity.completionNotes && (
                      <div className="text-xs text-emerald-600 bg-emerald-50 px-2 py-1 rounded border border-emerald-200 truncate">
