...
const ActivityLibraryDebug: React.FC<ActivityLibraryDebugProps> = ({
  ...
  return <div className="flex items-center justify-between bg-gradient-to-r from-purple-50 to-cyan-50 rounded-xl p-4 border border-purple-200">
      <div className="flex items-center space-x-3">
        ...
        <div>
          ...
          <p className="text-sm text-purple-600">
            ...
            {lastShuffle && <span className="ml-2">• Last shuffled: {lastShuffle.toLocaleTimeString()}</span>}
          </p>
        </div>
      </div>
      <div className="flex items-center space-x-2">
        <Button variant="outline" size="sm" onClick={handleReshuffle} className="bg-amber-300 hover:bg-amber-200">
