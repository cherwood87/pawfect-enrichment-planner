  ...
  <div className="min-h-screen bg-gradient-to-br from-blue-50 to-orange-50 flex items-center justify-center">
    <div className="text-center space-y-4 max-w-sm p-8">
      ...
      <div className="space-y-2">
        <p className="text-sm font-medium text-gray-700">Loading {routeName}...</p>
      ...
      <Route path="/app" element={
        <ProtectedRoute>
          <LazyLoadErrorBoundary componentName="Dashboard">
            <Suspense fallback={<CriticalRouteFallback routeName="Dashboard" />}>
              <IndexOptimized />
            </Suspense>
          </LazyLoadErrorBoundary>
        </ProtectedRoute>
      ...
      <Route path="/activity-library" element={
        <ProtectedRoute>
          <LazyLoadErrorBoundary componentName="Activity Library">
            <Suspense fallback={<CriticalRouteFallback routeName="Activity Library" />}>
              <ActivityLibraryPage />
            </Suspense>
          </LazyLoadErrorBoundary>
        </ProtectedRoute>
      ...
      <Route path="/dog-profile-dashboard/weekly-plan" element={
        <ProtectedRoute>
          <LazyLoadErrorBoundary componentName="Weekly Planner">
            <Suspense fallback={<CriticalRouteFallback routeName="Weekly Planner" />}>
              <WeeklyPlannerPage />
            </Suspense>
          </LazyLoadErrorBoundary>
        </ProtectedRoute>
      ...
      <Route path="/dog-profile-quiz" element={
        <ProtectedRoute>
          <LazyLoadErrorBoundary componentName="Dog Profile Quiz">
            <Suspense fallback={<StandardRouteFallback routeName="Dog Quiz" />}>
              <LazyDogProfileQuizPage />
            </Suspense>
          </LazyLoadErrorBoundary>
        </ProtectedRoute>
      ...
      <Route path="/settings" element={
        <ProtectedRoute>
          <LazyLoadErrorBoundary componentName="Account Settings">
            <Suspense fallback={<StandardRouteFallback routeName="Settings" />}>
              <LazyAccountSettings />
            </Suspense>
          </LazyLoadErrorBoundary>
        </ProtectedRoute>
