import { Heart, PlusCircle, Sparkles, Target, TrendingUp } from "lucide-react";
			...
			<div className="max-w-4xl mx-auto">
				...
				<div className="text-center mb-12">
					...
					<p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
						Transform your dog's life with science-based enrichment activities.
							...
							return (
								...
								>
									<CardContent className="p-6 flex items-center space-x-4">
										<div
											className={`w-12 h-12 rounded-2xl bg-${feature.color}-100 flex items-center justify-center flex-shrink-0 shadow-lg border-2 border-${feature.color}-200`}
										>
											<IconComponent
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
							<div className="text-center">
								...
								<p className="text-sm text-purple-600">
									Tell us about your furry friend's personality and needs
								</p>
							</div>
							...
							<div className="text-center">
								...
								<p className="text-sm text-purple-600">
									Discover which enrichment pillars your dog enjoys most
								</p>
							</div>
							...
							<div className="text-center">
								...
								<p className="text-sm text-purple-600">
									Get personalized activities and watch your dog thrive
								</p>
							</div>
						</div>
					</CardContent>
