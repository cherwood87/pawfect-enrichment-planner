        ...
        <Card className="bg-white/95 backdrop-blur-sm shadow-2xl rounded-3xl border-4 border-white/50">
          <CardContent className="p-12">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Join thousands of dog owners who have discovered the joy of a
              truly enriched, happy, and healthy dog. Start your journey in less
              than 2 minutes.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="text-center transform hover:scale-105 transition-all duration-300">
                ...
                <p className="text-sm text-gray-600">
                  Discover their enrichment preferences
                </p>
              </div>
              <div className="text-center transform hover:scale-105 transition-all duration-300">
                ...
                <p className="text-sm text-gray-600">
                  Start enriching their life today
                </p>
              </div>
            </div>
            ...
            <p className="text-sm text-gray-500 mt-4">
              No credit card required • Set up in under 2 minutes • Works for
              all dogs
            </p>
