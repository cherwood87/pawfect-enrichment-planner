...
const DashboardBanner: React.FC = () => {
  ...
  if (!user) return null;
  return <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 px-6 shadow-lg">
      <div className="max-w-6xl mx-auto flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <p className="text-zinc-50 font-medium">Welcome back, {user.email}!</p>
