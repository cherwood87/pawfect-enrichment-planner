					...
					<div className="flex flex-col lg:flex-row items-center justify-center space-y-8 lg:space-y-0 lg:space-x-12">
						...
						<div className="flex-1 max-w-lg text-left lg:text-left">
							...
							<p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed">
								Create personalized enrichment plans based on your dog's unique
								personality and needs. Track activities across different
								enrichment pillars for a happier, healthier pup.
							</p>
