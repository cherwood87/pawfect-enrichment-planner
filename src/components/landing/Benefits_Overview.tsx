	...
	const benefits = [
		{
			...
			description:
				"Built on proven canine behavior research and veterinary expertise to ensure your dog's optimal wellbeing.",
			color: "purple",
		...
		},
		{
			...
			description:
				"Take our personality quiz to get customized recommendations that match your dog's unique needs and preferences.",
			color: "cyan",
		...
		},
		{
			...
			description:
				"Monitor your dog's activities, build consistent routines, and watch their happiness and health improve over time.",
			color: "amber",
			...
			<div className="max-w-6xl mx-auto">
				<div className="text-center mb-16">
					...
					<p className="text-xl text-gray-600 max-w-3xl mx-auto">
						A fulfilled dog is a happy, healthy dog. Our comprehensive approach
						ensures your dog gets the mental, physical, social, instinctual and
						environmental enrichment they need to thrive.
					</p>
				</div>
					...
					{benefits.map((benefit, index) => {
						...
						return (
							...
							>
								<CardHeader>
									<div
										className={`w-16 h-16 mx-auto rounded-full ${benefit.iconBg} flex items-center justify-center mb-4 shadow-lg`}
									>
