...
export const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    pillar: 'mental',
    options: [
      { value: 'eager', label: 'Can’t wait to try and figure it out', weight: 3 },
      { value: 'guided', label: 'Waits for cues or guidance', weight: 2 },
      { value: 'needs_encouragement', label: 'Needs a lot of encouragement', weight: 1 },
      { value: 'disinterested', label: 'Gets overwhelmed or disinterested', weight: 0 }
    ]
  },
  {
    id: 'mental_problem_solving',
    question: 'What does your dog do if a toy or treat is stuck under something?',
    pillar: 'mental',
    options: [
      { value: 'problem_solves', label: 'Actively tries to figure it out', weight: 3 },
  ...
  // PHYSICAL PILLAR
  {
    ...
    pillar: 'physical',
    options: [
      { value: 'very_high', label: 'Constantly on the go, zoomies often', weight: 3 },
      { value: 'high', label: 'Moves around frequently, loves walks', weight: 2 },
  ...
  },
  {
    ...
    pillar: 'social',
    options: [
      { value: 'loves', label: 'Loves being petted, touched, or snuggled', weight: 3 },
  ...
  },
  {
    ...
    question: 'How interested is your dog in smells, textures, or objects in the environment?',
    pillar: 'environmental',
    options: [
      { value: 'obsessed', label: 'Sniffs and investigates everything', weight: 3 },
      { value: 'curious', label: 'Explores some things', weight: 2 },
      { value: 'occasional', label: 'Only occasionally curious', weight: 1 },
      { value: 'uninterested', label: 'Avoids or ignores most sensory things', weight: 0 }
    ]
  },
  ...
  },
  {
    ...
    options: [
      ...
      { value: 'puzzle_food', label: 'Food puzzles or treat-dispensing toys', weight: 2 },
  ...
  },
  {
    ...
    question: 'Have you ever seen your dog stalk, pounce, or dig instinctively?',
    pillar: 'instinctual',
    options: [
      { value: 'frequently', label: 'All the time, it’s their favorite', weight: 3 },
