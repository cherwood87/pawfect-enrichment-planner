	...
	const benefits = [
		{
			...
			description:
				"Get tailored enrichment recommendations based on your dog's personality and activity history.",
		...
		},
		{
			...
			description:
				"Receive guidance on achieving daily enrichment goals and balancing the five pillars.",
		...
		},
		{
			...
			description:
				"Access professional enrichment knowledge and troubleshooting for behavioral challenges.",
				...
				<div className="text-center space-y-6">
					...
					<div className="space-y-4">
						...
						<p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
							Your companion for creating the perfect enrichment plan. Get
							personalized advice, activity suggestions, and expert guidance
							tailored to {currentDog?.name || "your dog"}'s unique needs.
						</p>
					</div>
					...
					{benefits.map((benefit, index) => (
						...
						>
							<CardContent className="mobile-card space-y-4">
								<div
									className={`w-16 h-16 bg-gradient-to-br ${benefit.gradient} rounded-2xl flex items-center justify-center mx-auto group-hover:scale-110 transition-transform duration-300 border-2 border-purple-200`}
								>
					...
					<CardContent className="mobile-card space-y-6">
						<div className="text-center space-y-2">
							...
							<p className="text-purple-600">
								Get expert guidance on every aspect of enrichment
							</p>
						</div>
					...
					<CardContent className="mobile-card text-center space-y-6">
						<div className="space-y-2">
							...
							<p className="text-gray-600 leading-relaxed">
								Your coach is available 24/7 and knows all about{" "}
								{currentDog?.name || "your dog"}'s personality and activity
								history.
							</p>
						</div>
			...
			<Dialog open={isChatModalOpen} onOpenChange={setIsChatModalOpen}>
				<DialogContent className="p-0 modal-standard">
					...
					<DialogDescription className="sr-only">
						Chat with your AI enrichment coach for personalized advice and
						recommendations.
					</DialogDescription>
