...
const Landing: React.FC = () => {
  ...
  if (loading) {
    return <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 via-cyan-50 to-amber-50">
  ...
  return <div className="min-h-screen bg-gradient-to-br from-purple-50 via-cyan-50 to-amber-50">
      ...
      {!user && !session && <header className="absolute top-0 right-0 p-6 z-10">
