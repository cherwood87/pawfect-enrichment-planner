...
export const useActivityData = () => {
  ...
  if (!context) {
    throw new Error('useActivityData must be used within an ActivityStateV2Provider');
  }
  return context;
};
...
export const useActivityActions = () => {
  ...
  if (!context) {
    throw new Error('useActivityActions must be used within an ActivityStateV2Provider');
  }
  return context;
};
...
export const ActivityStateV2Provider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
