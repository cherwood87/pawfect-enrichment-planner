...
SET instructions = CASE
  ...
  WHEN pillar = 'social' THEN
    array_replace(instructions,
      'Complete when dog shows understanding or after 15-20 minutes maximum',
      'Watch dog\'s comfort level - end when still having positive interactions'
    )
...
SET instructions = instructions || CASE
  ...
  WHEN pillar = 'social' THEN ARRAY['Remember: Watch dog\'s body language and comfort level throughout the activity']
  ...
  ELSE ARRAY['Remember: Always prioritize your dog\'s wellbeing and end on a positive note']
END
